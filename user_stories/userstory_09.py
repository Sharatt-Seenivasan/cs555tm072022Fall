      ...
      for child_id in row['children']:
        ...
        if str(child_birthday) != 'nan':
          if str(husband_death) != 'nan' and greaterDate(str(child_birthday),str(husband_death)):
            print("ERROR: FAMILY: US09: " + family_id_indices[row['id']] + " Husband " + row['Husband ID'] + " in Family " + row['id'] + " dies before Child " + child_id + " is born.")
          if str(wife_death) != 'nan' and greaterDate(str(child_birthday),str(wife_death)):
            print("ERROR: FAMILY: US09: " + family_id_indices[row['id']] + " Wife " + row['Wife ID'] + " in Family " + row['id'] + " dies before Child " + child_id + " is born.")
